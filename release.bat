...
%zip% a -tzip "%bindir%\COMPASS-%version% (32-bit).zip" ".\%bindir%\32-bit\*" > NUL
%zip% a -tzip "%bindir%\COMPASS-%version% (64-bit).zip" ".\%bindir%\64-bit\*" > NUL
%zip% a -tzip "%bindir%\COMPASS-%version%.zip" ".\%bindir%\Any Cpu\*" > NUL
